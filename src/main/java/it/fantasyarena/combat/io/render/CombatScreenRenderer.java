...
public class CombatScreenRenderer {
    ...
    private int computeCurrentTurnColumnWidth() {
        ...
        return Math.clamp(longest, MIN_CURRENT_TURN_COLUMN_WIDTH, MAX_CURRENT_TURN_COLUMN_WIDTH);
    }
    ...
    private List<String> buildFighterCardsColumn() {
        List<String> lines = new ArrayList<>(cardFormatter.compactCard(1, first));
        lines.add("");
